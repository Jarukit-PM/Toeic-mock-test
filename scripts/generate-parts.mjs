...
const p6Set1Passages = [
  ...
  },
  {
    ...
    questions: [
      ...
      p6q("p6-1-q07", 7, ["submitting", "submit", "submitted", "submits"], "A", "Gerund after preposition 'for' implied in 'arrange for'."),
...
const p6Set2Passages = [
  {
    ...
    questions: [
      ...
      p6q("p6-2-q02", 2, ["restrict", "restricted", "restricting", "restriction"], "B", "Adjective: dietary restrictions."),
